...
class GaussianDDPMClassifierFreeGuidance(pl.LightningModule):
    ...
    def __init__(self,
                 denoiser_module: nn.Module,  # MLP
                 T: int,  # default: 4_000
                 w: float,  # default: 0.3
                 p_uncond: float,  # default:
                 width: int,  # default:
                 height: int,  # default:
                 input_channels: int,  # default:
                 num_classes: int,  # default: number of attributes / classes
                 logging_freq: int,  # default:
                 v: float,  # default:
